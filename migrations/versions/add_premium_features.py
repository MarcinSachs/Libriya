...
def upgrade():
    ...
    with op.batch_alter_table('tenant', schema=None) as batch_op:
        batch_op.add_column(sa.Column('premium_bookcover_enabled', sa.Boolean(), nullable=False, server_default=sa.false()))
        batch_op.add_column(sa.Column('premium_biblioteka_narodowa_enabled', sa.Boolean(), nullable=False, server_default=sa.false()))
